...
load('password.rda')
load('user.password.rda')
invisible(aoptions("github_token", github_token))
invisible(aoptions("user", "MarcinKosinski"))
invisible(aoptions("password", user.password))
deleteLocalRepo('RTCGA_UseCases', deleteRoot = TRUE)
deleteGitHubRepo('RTCGA_UseCases', deleteRoot = TRUE)
```
